...
class ContactUsCrudController extends CrudController
{
   ...
   // use \Backpack\CRUD\app\Http\Controllers\Operations\CreateOperation;
    ...
    protected function setupListOperation()
    {
        ...
        $this->data['contact'] = ContactUs::find(1);
        
        $emails = $contact->email;
        $phones = $contact->phone;
        $this->data['emails'] = json_decode($emails, true);
        $this->data['phones'] = json_decode($phones, true);
        return view('contact.contact_page',$this->data);
        /**
