...
@section('content')
    ...
    <section class="p-0">
            <div class="carousel">
                ...
                <div class="carousel-inner">
                    @foreach($slider as $sl)
                        <div class="carousel-item {{ ($sl->id==1 ? 'active':'active') }}">
                            <img src="{{asset('')}}uploads/{{$sl->image}}" class="d-block w-100" title="{{$sl->titles}}">
                        </div>
                    @endforeach
                </div>
        ...
        <div class="container-fluid">
            <div class="row ">
                <div class="col-lg-3 col-md-6">
                    <a href="#">
                        <img src="{{asset('uploads/card_1.jpg')}}"
                ...
                <div class="col-lg-3 col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                            <img src="{{asset('uploads/card_2.jpg')}}"
                                    class="img-fluid blur-up lazyload ">
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-lg-3 col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-end">
                            <div class="">
                                <img src="{{asset('uploads/card_3.jpg')}}"
                                    class="img-fluid blur-up lazyload ">
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-lg-3 col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="{{asset('uploads/card_4.jpg')}}"
                                    class="img-fluid blur-up lazyload ">
                            </div>
                        </div>
                    </a>
            ...
            @foreach($all as $pr)
                ...
                <div class="product-box col-xl-2 col-lg-3 col-sm-4 col-6">
                    <div class="img-wrapper">
                        <div class="front">
                            <a href="{{route('product_detail',$pr->id)}}" id="d_d" style="background-image:url({{asset('')}}uploads/{{$pr->image}})">
                                @if(substr($pr->image, -5) =='.webp')
                                <img src="{{asset('')}}uploads/default-image.webp"
                                    class="img-fluid blur-up lazyload bg-img" alt="">
                                @else 
                                <img src="{{asset('')}}uploads/{{$pr->image}}"
                                class="" style="width:100%;height: 216px;object-fit: contain;" alt="">
                                @endif
                            </a>
                        </div>
                    ...
                    <div class="product-detail">
                        ...
                        <a href="{{route('product_detail',$pr->id)}}" class="mb-3">
                            <h6>{{$pr->title}}</h6>
                        </a>
                        @if(Auth::check())
                        <div class="row">
    ...
    <!-- Parallax banner -->
    <section class="pb-3">
        <div class="text-end p-right">
            <img src="{{asset('uploads/banner_footer.jpg')}}" alt="" class="img-fluid blur-up lazyload">
        </div>
    </section>
    <!-- Parallax banner end -->
