...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('create_value')}}" method="post">
            @csrf 
            <div class="form-group mb-3">
                <label for="">Title</label>
                <input type="text" name="title_attrs" class="form-control" placeholder="title">
            </div>
            <div class="form-group mb-3">
...
<script>
    $(function(){
        $('#addAttribute').on('click',function(){
            $('#respons_values').append('<div class="col-3 mb-3"><input type="text" name="value[]" placeholder="Name" class="form-control"></div>');
        })
    })
</script>
@endsection