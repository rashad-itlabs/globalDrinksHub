            ...
            <div class="row section-b-space">
                ...
                <div class="col-lg-5">
                    <div class="contact-right">
                        <ul>
                            <li>
                                <div class="contact-icon"><img src="{{asset('')}}assets/frontend/images/icon/phone.png"
                            ...
                            <li>
                                ...
                                <div class="media-body">
                                    <p style="width:175px">{{$contact->address}}</p>
                                </div>
                            </li>
                            <li>
                                <div class="contact-icon"><img src="{{asset('')}}assets/frontend/images/icon/email.png"
                                        alt="Generic placeholder image">
                                    <h6>Address</h6>
                                </div>
                                <div class="media-body">
